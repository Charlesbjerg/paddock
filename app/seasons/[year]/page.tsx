  ...
  return (
    <div className="container py-12">
      ...
      <div className="grid grid-cols-5 gap-6">
        {races.map((race) => (
          <RaceCard key={race.id} race={race} circuit={race.circuit} circuitFlag={race.countryCode} 
          results={{ p1: race.p1, p2: race.p2, p3: race.p3, fastest: { time: race.fastestLap, driver: race.fastestLapDriver} }} />
        ))}
      </div>
    </div>
  );
